...
class LogicaMock():
    ...
    def __init__(self):
        ...
        self.personas = [{'id' : 1, 'nombre': 'Federico', 'apellido': 'Contreras', 'edad': 15, 'talla': 1.53, 'peso': 50, 'brazo': 15, 'pecho': 80, 'cintura': 70, 'pierna': 35, 'fecha_retiro': '', 'razon_retiro': ''},
                         {'id' : 2, 'nombre': 'Angelica', 'apellido': 'Mora', 'edad': 42, 'talla': 1.90, 'peso': 75, 'brazo': 18, 'pecho': 95, 'cintura': 76, 'pierna': 40, 'fecha_retiro': '2023-03-30', 'razon_retiro': 'Incapacidad'},
                         {'id' : 3, 'nombre': 'Julian', 'apellido': 'Salazar', 'edad': 30, 'talla': 1.69, 'peso': 59, 'brazo': 17, 'pecho': 69, 'cintura': 60, 'pierna': 28, 'fecha_retiro': '2023-01-18', 'razon_retiro': 'Cambio de instructor'},
                         {'id' : 4, 'nombre': 'Bruno', 'apellido': 'Diaz', 'edad': 26, 'talla': 1.53, 'peso': 60, 'brazo': 16, 'pecho': 72, 'cintura': 54, 'pierna': 20, 'fecha_retiro': '', 'razon_retiro': ''},
                        ]

        self.ejercicios = [
            {'id' : 1, 'nombre': 'Press de pierna', 'descripcion': 'Ejercicio de entrenamiento con pesas en el que el individuo empuja un peso o una resistencia con las piernas', 'youtube': 'https://www.youtube.com/watch?v=zac9BPZiUTQ', 'calorias': 120}, \
            {'id' : 2, 'nombre': 'Sentadilla', 'descripcion': 'Ejercicio de fuerza en el que se baja la cadera desde una posición de pie y luego vuelve a levantarse.', 'youtube': 'https://www.youtube.com/watch?v=l7aszLSPCVg', 'calorias': 80}, \
            {'id' : 3, 'nombre': 'Abducción de cadera', 'descripcion': 'Mover la pierna derecha hacia la derecha o alejarla del cuerpo y viceversa', 'youtube': 'https://www.youtube.com/watch?v=dILxTvY88uI', 'calorias': 90}
        ]

        self.entrenamientos = [{'persona': 'Federico', 'ejercicio': 'Press de pierna', 'fecha': '2023-01-18', 'repeticiones': 15, 'tiempo': 20, 'id' : 1},
                               {'persona': 'Federico', 'ejercicio': 'Sentadilla', 'fecha': '2023-01-18', 'repeticiones': 12, 'tiempo': 5, 'id' : 2},
                               {'persona': 'Federico', 'ejercicio': 'Press de pierna', 'fecha': '2023-03-11', 'repeticiones': 15, 'tiempo': 20, 'id' : 3},
                               {'persona': 'Bruno', 'ejercicio': 'Press de pierna', 'fecha': '2023-01-18', 'repeticiones': 15, 'tiempo': 30, 'id' : 4},
                               {'persona': 'Bruno', 'ejercicio': 'Sentadilla', 'fecha': '2023-07-02', 'repeticiones': 10, 'tiempo': 5, 'id' : 5}
                               ]
